...
<div id="wrapper">
  ...
  <div class="nav-user">
    ...
    <div id="right">
   <h1 style="padding:0px;" id="welcome">All books</h1>   
...
$q = "SELECT book_id AS id, book_title AS title, book_edition AS edition, book_publisher AS publisher, year_published AS year FROM books ORDER BY date_registered asc LIMIT $start, $display";		
$r = @mysqli_query ($dbc, $q); 
...
if ($num > 0) { 
	...
	while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
		echo '<tr><td align="left"><a href="BooksInfo.php?id=' . $row['id'] . '">' . $row['title'] . '</a></td><td align="left">' . $row['edition'] . '</td><td align="left">' . $row['publisher'] . '</td><td align="left">' . $row['year'] . '</td></tr>';
	}
