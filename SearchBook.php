...
<div id="wrapper">
  ...
  <li style="background: -webkit-linear-gradient(top,#E1E9F2,white); box-shadow: 0 0 5px #ECEFF7 inset;"><a href="SearchBook.php">Search book</a></li>
  <li><a href="AllBooks.php">All books</a></li>  
  <li><a href="AddPeople.php">Add people</a></li>
  <li id="nav-rb"><a href="AllPeople.php">All people</a></li>
  </ul>
    
    <form id="addUserForm" action="SearchBook.php" method="post">
      <h3 id="addNewUser"><a href="SearchBook.php"><img id="search" src="search.png"></a>Search book</h3>  

	<label>Title: <input type="text" name="book_title" size="30" maxlength="40" autofocus value="<?php if (isset($_POST['book_title'])) echo $_POST['book_title']; ?>" /></label><br />
...
if ($num > 0) { 
	...
	echo '<p class="errorP">Searched book does not exist.</p>';
		...
		echo '</p><p class="errorP"><strong><a class="errorP" href="AddUser.php">Please try again.</a></strong></p><p><br /></p>';	
	} 
