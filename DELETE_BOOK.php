...
<div id="wrapper">
  ...
  <li id="nav-rb"><a href="AllPeople.php">All people</a></li>
   ...
   <form id="addUserForm" action="DELETE_BOOK.php" method="post">
      <h3 id="addNewUser"><a href="AllBooks.php"><img id="delete" src="delete.png" /></a> Delete book</h3>  
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($_POST['sure'] == 'Yes') { 
		...
		$q = "DELETE FROM books WHERE book_id=$id LIMIT 1";		
		...
		if (mysqli_affected_rows($dbc) == 1) { 
			...
			echo '<p class="error">The book could not be deleted due to a system error.</p>'; 
	...
	if (mysqli_num_rows($r) == 1) { 
		...
		echo "Do you want to delete <strong>$row[0]</strong> from books? <br />";
		
		echo '<form id="confirm" action="DELETE_BOOK.php" method="post" color="black">
