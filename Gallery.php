...
<meta charset="utf-8">
<title>SSST Library - Gallery</title>
...
<div id="wrapper">
  ...
  <li style="background: -webkit-linear-gradient(top,#E1E9F2,white); box-shadow: 0 0 5px #ECEFF7 inset;"><a href="Gallery.php">Gallery</a></li>
  ...
  <div class="nav-user">
    ...
    <div id="right">
   <h1 style="padding:0px;" id="welcome">Gallery</h1>   

<div style="border:1px #BDC5CD solid; padding:20px; margin-top:15px; border-radius:10px; font-size:20px;">
<div class="container">
    <div id="slides">
      <img src="DSC_0197.JPG" alt="SSST library"/>
      <img src="_MG_7586.jpg" alt="SSST library"/>
      <img src="DSC_0200.JPG" alt="SSST library"/>
      <img src="DSC_0198.JPG" alt="SSST library"/>
      <img src="DSC_0197.JPG" alt="SSST library"/>
      <img src="DSC_0203.JPG" alt="SSST library"/>
      <img src="library.jpg" alt="SSST library"/>
