...
<meta charset="utf-8">
<title>SSST Library - Change password</title>
...
<div id="wrapper">
  ...
  <div class="nav-user">
	    <ul>
	        ...
	        <li style="opacity:0.8;"><a href="ChangePassword.php"id="nav-fift">Change password</a></li>
    ...
    <div id="right">
   <h1 style="padding:0px;" id="welcome">Change password</h1>   

<div style="padding:20px; margin-top:15px; border-radius:10px; font-size:22px; line-height:40px;">
...
require ('mysqli_connect.php'); 
	...
	echo '<form id="addUserForm" action="ChangePassword.php" method="post">';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if ($_POST['pass1'] != $_POST['pass2']) {
			...
			$q = "UPDATE users SET user_password='$p' WHERE user_id=$id LIMIT 1";
			$r = @mysqli_query ($dbc, $q);
			if (mysqli_affected_rows($dbc) == 1) { 

				echo '<p class="greenP">Password changed.</p><br /><br />';	
...
?>
<label>New Password: <input autofocus required type="password" name="pass1" size="20" maxlength="30"  /></label> <br />
<label>Confirm Password: <input required type="password" name="pass2" size="20" maxlength="30" /></label> <br />	
