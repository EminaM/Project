...
<form id="addUserForm" action="DELETE_RESERVATION1.php" method="post">
      <h3 id="addNewUser"><a href="AllPeople.php"><img id="delete" src="delete.png" /></a> Delete reservation</h3> 
      	<a href="SEE_RESERVATIONS.php" title="Back"><img style="float:right;" src="back _small.png"></a><br />
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$user_id=$_SESSION['user_id'];
		...
		$q = "DELETE FROM reservations WHERE reservation_id = $id";		
		$r = @mysqli_query ($dbc, $q);
		if (mysqli_affected_rows($dbc) == 1) {

			echo '<p>Reservation has been deleted.</p>';	
		...
		echo "
		Do you want to delete reservation? <br />";
		
		echo '<form id="confirm" action="DELETE_RESERVATION1.php" method="post" color="black">
