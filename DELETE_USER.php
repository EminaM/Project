...
<div id="wrapper">
  ...
  <li id="nav-rb"><a href="AllPeople.php">All people</a></li>
   ...
   <form id="addUserForm" action="DELETE_USER.php" method="post">
      <h3 id="addNewUser"><a href="AllUsers.php"><img id="delete" src="delete.png" /></a> Delete user</h3>  
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$q = "SELECT CONCAT(user_name, ' ', user_surname) FROM users WHERE user_id=$id";
	$r = @mysqli_query ($dbc, $q);
	...
	if (mysqli_num_rows($r) == 1) { 
		...
		echo "
		Do you want to delete <strong>$row[0]</strong> from users? <br />";
