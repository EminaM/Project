...
<meta charset="utf-8">
<title>SSST Library - Delete reservation</title>
...
<div id="wrapper">
  ...
  <div class="nav-user">
    ...
    <div id="right">
   <h1 style="padding:0px;" id="welcome">Delete reservation</h1>   

    
    <form id="addUserForm" action="DELETE_RESERVATION.php" method="post">
      	<a href="Account.php" title="Back"><img style="float:right;" src="back _small.png"></a><br />
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$user_id=$_SESSION['user_id'];
		...
		echo '<form id="confirm" action="DELETE_RESERVATION.php" method="post" color="black">
